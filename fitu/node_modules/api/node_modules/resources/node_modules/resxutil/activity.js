...
exports.getFields = { _id: 1, siteId: 1, vendorId: 1, name: 1, price: 1, startsOn: 1, endsOn: 1, tags: 1, intro: 1, picUrl: 1, capacity: 1, createdOn: 1, createdBy: 1, statusId: 1, bar: 1 };
exports.convActivityInfo = function (act, creators, sites, vendors, members, msgs) {
    var ret = { id: act._id.toString(), name: act.name, price: act.price, startsOn: act.startsOn, endsOn: act.endsOn, tags: act.tags, intro: act.intro, picUrl: act.picUrl, capacity: act.capacity, createdOn: act.createdOn, createdBy: act.createdBy, statusId: act.statusId, bar: act.bar };
...
exports.getRelatedActivityFields = { _id: 1, name: 1, price: 1, startsOn: 1, endsOn: 1, picUrl: 1, createdBy: 1, tags: 1, statusId: 1 };
exports.convRelatedActivityInfo = function (act) {
    return { id: act._id.toString(), name: act.name, price: act.price, startsOn: act.startsOn, endsOn: act.endsOn, picUrl: act.picUrl, createdBy: act.createdBy, tags : act.tags, statusId: act.statusId };
};
