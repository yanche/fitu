...
Note.prototype.toSysNote = function (options) {
    ...
    this.subject = { content: options.subject, type: options.subjectHTML ? constants.note.contentTypes.html : constants.note.contentTypes.plain };
    this.body = { content: options.body, type: options.bodyHTML ? constants.note.contentTypes.html : constants.note.contentTypes.plain };
