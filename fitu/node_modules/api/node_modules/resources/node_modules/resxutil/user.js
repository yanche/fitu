...
exports.getFields = { '_id': 1, 'personal': 1, 'email': 1, 'headUrl': 1, 'fans': 1, 'subscribe': 1 };
exports.convUserInfo = function (user) {
    return { 'id': user._id.toString(), 'personal': user.personal, 'email': user.email, 'headUrl': user.headUrl, 'fansCount': user.fans.length, 'subscribe': { usersCount: user.subscribe.users.length, sitesCount: user.subscribe.sites.length } };
};
...
exports.getRelatedUserFields = { '_id': 1, 'personal': 1, 'headUrl': 1, 'fans': 1 };
exports.convRelatedUserInfo = function (user) {
    return { 'id': user._id.toString(), 'personal': user.personal, 'headUrl': user.headUrl, 'fansCount': user.fans.length };
};
...
exports.getPublicUserFields = { '_id': 1, 'personal.contact': 1, 'personal.gender': 1, 'personal.nickName': 1, 'headUrl': 1, 'fans': 1 };
