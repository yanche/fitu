...
exports.convUserInfo = function (user) {
    return { 'id': user._id.toString(), 'personal': user.personal, 'email': user.email, 'headUrl': user.headUrl, 'fansCount': user.fans.length, 'subscribe': { usersCount: user.subscribe.users.length } };
};
