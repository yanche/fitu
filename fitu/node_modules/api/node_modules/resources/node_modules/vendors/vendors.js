    ...
    .then(function (httpOptions) {
        ...
        if (status.isOK()) {
            ...
            if (validate.isString(me.args.intro))
                ...
                throw new errdef.DeferChainKiller(extension.http.webres400());
            //logoUrl
            if (validate.picBase64(me.args.logoUrl))
                create.logoUrl = me.args.logoUrl;
            else if (validate.url(me.args.logoUrl)) {
                var parsed = extension.string.parseExternalStorageUrl(me.args.logoUrl);
                if (parsed)
                    create.logoUrl = parsed;
                else
                    create.logoUrl = { path: config.defaultVendorLogoUrl, storage: 'local' };
            }
