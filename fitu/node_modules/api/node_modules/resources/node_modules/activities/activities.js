...
Activities.prototype._post = function () {
    ...
    .then(function (inserted) {
        ...
        note.toSysNote({ emphasis: false, subject: '<div>活动<strong>' + inserted.name + '</strong>创建成功！</div>', subjectHTML: true, body: '<div>活动详情请<a href="/actdetail?actId=' + inserted._id.toString() + '">查看</a></div><div>已报名人员名单请<a href="/myself/actlead?actId=' + inserted._id.toString() + '">查看</a></div><div>快召集小伙伴一起动起来！</div>', bodyHTML: true, recipients: [inserted.createdBy] });
        //TODO: log if failed
