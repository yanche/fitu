                    ...
                    if (act) {
                        ...
                        .then(function (ok) {
                            if (ok)
                                ...
                                return httpOptions.setStatus('POST', 401).setStatus('DELETE', 401);
                        });
                    }
                    else
                        return httpOptions.setStatus('POST', 404).setStatus('DELETE', 404);
                });
            }
        });
    }
    ...
    .then(function (act) {
        if (act) {
            ...
            return bluebird.all([
                ...
                act.vendorId ? db.vendor.getOneVendorFieldsBy({ _id: act.vendorId }, resxutil.vendor.getRelatedVendorFields) : null,
...
SingleActivity.prototype._post = function () {
    var me = this;
    return me._accessibility()
    .then(function (httpOptions) {
    ...
    .then(function (currentAct) {
        ...
        if (validate.value(me.args.intro)) {
            if (validate.isString(me.args.intro))
                update.intro = me.args.intro.trim();
            else
                throw new errdef.DeferChainKiller(extension.http.webres400());
        }
        //bar
        ...
        if (validate.value(me.args.startsOn)) {
            ...
            if (!isNaN(startsOn.getTime()) && startsOn.getTime() == me.args.startsOn && startsOn.getTime() >= (new Date()).getTime())
        ...
        if (validate.value(me.args.endsOn)) {
            ...
            if (!isNaN(endsOn.getTime()) && endsOn.getTime() == me.args.endsOn && endsOn.getTime() >= startsOn.getTime())
