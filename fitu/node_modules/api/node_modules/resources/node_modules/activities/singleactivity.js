...
SingleActivity.prototype._get = function () {
    ...
    .then(function (act) {
        if (act) {
            ...
            return bluebird.all([
                ...
                db.siteidle.getOneSiteIdleFieldsBy({ _id: act.siteIdleId }, resxutil.siteidle.getRelatedSiteIdleFields),
                ...
                db.member.getMembersFieldsBy({ actId: act._id }, { _id: 1, actId: 1 })
            ]);
        }
        else
    ...
    .then(function (data) {
        var creator = data[0], siteidle = data[1], site = data[2], vendor = data[3];
        return resxutil.activity.convActivityInfo(activity, creator ? [creator]: [], siteidle ? [siteidle] : [], site ? [site] : [], vendor ? [vendor] : [], data[4]);
    })
    .then(function (data) {
