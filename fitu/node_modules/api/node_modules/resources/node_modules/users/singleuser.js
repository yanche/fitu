...
var SingleUser = function (webreq) {
    ...
    me.targetUser_CL = new infra.CachedLoader(function () {
        return db.user.getOneUserFieldsBy({ _id: me.filter.userObjId }, resxutil.user.getFields);
    });
};
...
SingleUser.prototype._accessibility = function () {
    ...
    httpOptions.setStatus('GET', 400).setStatus('PUT', 400).setStatus('DELETE', 400);
    var me = this;
    if (!me.filter.userObjId)
        ...
        return bluebird.resolve(httpOptions.setStatus('GET', 200).setStatus('PUT', 200).setStatus('DELETE', 409));
    else {
...
SingleUser.prototype._get = function () {
    ...
    .then(function (data) {
        if (data)
            return resxutil.user.convUserInfo(data);
        else
