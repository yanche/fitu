...
Members.prototype._post = function () {
    ...
    .then(function (httpOptions) {
        ...
        if (status.isOK()) {
            var create = { createdOn: new Date(), actId: me.filter.actObjId, userId: me.operator.objId, statusId: constants.status.memberStatus.pending, payStatusId: constants.status.memberPayStatus.unpaid };
