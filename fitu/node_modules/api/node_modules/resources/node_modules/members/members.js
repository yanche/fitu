...
Members.prototype._post = function () {
    ...
    .then(function (httpOptions) {
        ...
        if (status.isOK()) {
            var create = { createdOn: new Date(), actId: me.filter.actObjId, userId: me.operator.objId };
            return db.activity.getOneActFieldsBy(create.actId, { _id: 1, name: 1, createdBy: 1 })
            .then(function (act) {
                targetAct = act;
                if (targetAct)
