...
Members.prototype._post = function () {
    ...
    .then(function (inserted) {
        ...
        note.toSysNote({ emphasis: false, subject: '<div>活动<strong>' + targetAct.name + '</strong>报名成功啦！</div>', subjectHTML: true, body: '<div>活动详情请<a href="/actdetail?actId=' + targetAct._id.toString() + '">查看</a></div>', bodyHTML: true, recipients: [me.operator.objId] });
        //TODO: log if failed
        ...
        //TODO: improve the format
        note2.toSysNote({ emphasis: false, subject: '你组织的活动' + targetAct.name + '有人报名啦！', subjectHTML: false, body: '<div>已报名人员的名单请<a href="/myself/actlead?actId=' + targetAct._id.toString() + '">查看</a></div>', bodyHTML: true, recipients: [targetAct.createdBy] });
        //TODO: log if failed
