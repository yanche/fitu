        ...
        .then(function (data) {
            ...
            if (!mem)
                ...
                if (mem.userId.equals(me.operator.objId)) //self
                    ...
                    return httpOptions.setStatus('GET', 200).setStatus('DELETE', 401);
                else
                    return httpOptions.setStatus('GET', 401).setStatus('DELETE', 401);
            }
        });
    }
};
...
SingleMember.prototype._delete = function () {
    ...
    .then(function (currentAct) {
        if (currentAct && currentAct.startsOn > new Date()) //act starts on future
