...
SingleMessage.prototype._accessibility = function () {
    ...
    return bluebird.resolve(httpOptions.setStatus('GET', this.filter.msgObjId ? 200 : 400).setStatus('PUT', this.filter.msgObjId ? (this.operator ? 200 : 401) : 400));
};
...
SingleMessage.prototype._put = function () {
    var me = this;
    return me._accessibility()
    .then(function (httpOptions) {
