...
SingleNote.prototype._accessibility = function () {
    ...
    if (!me.filter.noteObjId)
        return bluebird.resolve(httpOptions.setStatus('POST', 400).setStatus('DELETE', 400));
    if (!me.operator)
        ...
        .then(function (data) {
            if (!data[1])
                ...
                return httpOptions.setStatus('POST', 200).setStatus('DELETE', me.filter.removeByAuthor ? 401 : 200);
            else if (data[1].authorId.equals(me.operator.objId))
                return httpOptions.setStatus('POST', 401).setStatus('DELETE', me.filter.removeByAuthor ? 200 : 401);
            else
...
SingleNote.prototype._post = function () {
    var me = this;
