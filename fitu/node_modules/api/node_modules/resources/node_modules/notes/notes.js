...
Notes.prototype._get = function () {
    ...
    .then(function (data) {
        ...
        var relatedUsers = [];
        notes.forEach(function (n) { relatedUsers.push(n.authorId); relatedUsers.push(n.replyToId); })
...
Notes.prototype._post = function () {
    ...
    .then(function (receivers) {
        var create = { type: constants.note.types.note, createdOn: new Date(), authorId: me.operator.objId, recipients: receivers, emphasis: Boolean(me.args.emphasis) };
        if (validate.valuedString(me.args.subject))
            create.subject = me.args.subject;
        else
            throw new errdef.DeferChainKiller(extension.http.webres400()); //TODO: no 'enter': /r/n
        create.content = me.args.content; //TODO: content
