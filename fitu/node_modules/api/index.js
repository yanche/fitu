...
var handle = function (webreq) {
    ...
    .then(function (webres) {
        ...
        webres.setHeader('Access-Control-Allow-Methods', 'GET, POST, DELETE, OPTIONS');
...
var resFactories = {
    ...
    actcensus: resources.actcensusResFactory,
    pwdreset: resources.pwdresetResFactory,
    pendingnotes: resources.pendingNotesResFactory,
    credits: resources.creditsResFactory,
    smsvc: resources.smsvcResFactory,
    dataprint: resources.dataprintFactory
};
