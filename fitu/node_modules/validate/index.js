...
var validateGender = function (str) {
    return str == constants.common.gender.male || str == constants.common.gender.female || str == constants.common.gender.unknown;
};
...
var validateEmail = function (str, optional) {
    return (isString(str) && emailRegex.test(str)) || (optional && validateNullOrEmptyString(str));
};
    ...
    if (Array.isArray(tags)) {
        for (var i = 0; i < tags.length; ++i) {
            if (constants.tags.some(function (t) { return t.key == tags[i]; })) {
                if (ret.every(function (r) { return r != tags[i]; })) {
                    ret.push(tags[i]);
                }
            }
            else
...
exports.func = isFunc;
exports.actBar = validatorOfStringInRange({ max: 20 });
