    ...
    .then(function (modi) {
        ...
        if (isNaN(ims) || fileModifiedOn != ims) {
            ...
            .then(function (cachedFile) {
                ...
                retHeaders['Cache-Control'] = (config.env == 'prod' ? ('public, max-age=' + extension.datetime.getFileMaxAge()) : 'no-cache');
            ...
            return extension.http.webres304({ 'Cache-Control': config.env == 'prod' ? ('public, max-age=' + extension.datetime.getFileMaxAge()) : 'no-cache' });
        }
    })
    .catch(function (err) {
