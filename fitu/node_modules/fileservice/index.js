    ...
    .then(function (modi) {
        ...
        if (isNaN(ims) || fileModifiedOn != ims) {
            ...
            .then(function (cachedFile) {
                ...
                console.log(webreq._raw.headers['accept-encoding']);
                console.log(_gzip.regex.test(webreq._raw.headers['accept-encoding'] || ''));
                console.log(cachedFile.gzip && _gzip.regex.test(webreq._raw.headers['accept-encoding'] || ''));
            ...
            return extension.http.webres304();
        }
    })
    .catch(function (err) {
