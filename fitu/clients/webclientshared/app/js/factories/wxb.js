(function () {
    ...
    var WeixinApi = (function () {
         ...
         */
        var weixinShareTimeline = function (data, callbacks) {
            callbacks = callbacks || {};
         ...
         * @p-config    {Function}  all(resp)       无论成功失败都会执行的回调
         */
        var weixinSendAppMessage = function (data, callbacks) {
            callbacks = callbacks || {};
         ...
         * @p-config    {Function}  all(resp)       无论成功失败都会执行的回调
         */
        var weixinShareWeibo = function (data, callbacks) {
            callbacks = callbacks || {};
         ...
         */
        var imagePreview = function (curSrc, srcList) {
